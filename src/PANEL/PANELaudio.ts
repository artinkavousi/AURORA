/**
 * PANEL/PANELaudio.ts - Unified Audio Reactivity Panel
 * 
...
import type { EnhancedAudioData } from '../AUDIO/core/enhanced-audio-analyzer';
import type { GestureSelection } from '../AUDIO/kinetic/gesture-interpreter';
import type { EnsembleState } from '../AUDIO/kinetic/ensemble-choreographer';
import type { SpatialState } from '../AUDIO/kinetic/spatial-composer';
import { GestureFactory } from '../AUDIO/kinetic/gesture-primitives';
import { PersonalityType, getAllPersonalityProfiles } from '../AUDIO/kinetic/personality-profiles';
import type { PersonalityBlendState } from '../AUDIO/kinetic/personality-engine';
import { MacroType, MACRO_PRESETS, type MacroState } from '../AUDIO/kinetic/macro-control';
import type { PlaybackState, RecorderState } from '../AUDIO/kinetic/sequence-recorder';
...
export class AudioPanel {
  ...
  constructor(
    ...
    const { pane } = dashboard.createPanel('audio', {
      title: '🎵 Audio Kinetic Performer',
      position: { x: window.innerWidth - 360, y: 60 },
      expanded: true,
      draggable: true,
      collapsible: true,
    });
